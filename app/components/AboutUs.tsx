...
const AboutUs = (): React.ReactNode => {
    return (
        <div id="ABOUT US" className='text-lg bg-black text-black p-12 flex justify-center xs:p-0'>
            <div className=' flex flex-col text-center gap-4 bg-white italic p-12 w-[30%] xs:w-full xs:h-[50%] sm:w-full md:w-full lg:w-full xl:w-[50%] xxl:w-[50%]'>
